...
function Project() {
    ...
    <img className="w-32 mx-auto shadow-xl rounded-full drop-shadow-sm" src={login} alt="profile face" />
        ...
        <div className="flex align-center justify-center mt-4">
                  ...
                  <a target="_blank" rel="noreferrer"className="text-xl m-1 p-1 sm:m-2 sm:p-2 text-teal-500 hover:bg-black rounded-full hover:text-white transition-colors duration-300" href="https://icodejr.vercel.app/">
                    <CgWebsite />
